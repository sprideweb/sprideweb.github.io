...
function goN(e) {
	window.location.href='#/index/xwxqy.html#'+e;
}
function goB(e) {
	window.open('#/index/xwxqy.html#'+e,'_blank');
}
function basI(e,e2,e3,e4) {
	...
	if(e2>2030||e3>12||e4>31) {
		document.getElementById('newsinfo').innerHTML='时间：9999-99-99\u3000\u3000供稿：';
	}
