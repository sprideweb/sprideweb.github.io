...
if(SYFL === '1') {
	...
	addAList('请使用现代浏览器访问本站页面','2024','11','07');
	addAList('更新日志','1000','00','00');
}
...
switch(ID) {
case '10000000':
	var op = `<bg>2024.11.07更新内容</bg><zz>新增栏目：通知公告;<br/>新增导航栏（自适应）；<br/>取消投稿按钮；</zz>`;
...
写于2021.11.16冬夜</ri>var first_sceen__time = (+new Date());
...
case '20241026':
	...
	break;
case '20241107':
	var op = `<center><bg>请使用现代浏览器访问本站页面</bg><br></center><zz>\u3000\u3000本站采用部分最新技术以提升网站可读性，因此请使用现代浏览器访问本站页面，否则可能发生错误。<br/><br/>\u3000\u3000建议您使用以下浏览器版本：IE浏览器9.0版本及以上； Google Chrome浏览器 63版本及以上； 360浏览器9.1版本及以上，且IE内核9.0及以上。<br/><br/>\u3000\u3000使用非现代浏览器可能导致网页显示异常，影响您的阅读体验。</zz>`;
	basicInfo('请使用现代浏览器访问本站页面');
	break;
default:
	if(IS==='article') {
		elHide('article_main');
...
case 'post':
	...
	break;
case 'aboutus.2022':
	var ox = `春潮网由春潮编辑部主办，经授权首发来自春潮的精品文章。`;
	specialInfo('关于本站');
	break;
case 'lxhz':
...
case 'author:NLS':
	...
	break;
case 'author:春潮编辑部':
	var ox = `<zuoz>春潮编辑部<w>Spride</w></zuoz>`;
	authorPage();
	break;
case 'author:307':
...
function basicInfo(x1,x2) {5
	...
	if(ox===1) {
		document.getElementById('art-content').innerHTML = `<p style="line-height:1;text-align:center;font-size:14px;color:#9f9f9f;margin:180px 0;"><img src="https://1.s140i.faiscm.com/4/AIwBCAAQBBgAIM_Mu94FKJXmt6sGMHM4cw.png" style="width:90px!important;user-select:none;"/>此文章仅支持在微信公众号内查看</p>`;
	}
 	elTitl(x1);
} 
