...
case '0':
	...
	break;
case '20211116':
	var op = `<p>遥记得2019年初冬天的情景。那时候我还有几个月就要中考，却远没有像高考这般紧张。因为我知道，考的高就去附中，低了也不会低过省实验。
...
case 'post':
	...
	break;
case 'aboutus.2022':
	var ox = `春潮网——春潮编辑部旗下新一代在线阅读平台，经授权首发或转载来自春潮的精品文章。`;
	specialInfo('关于我们');
	break;
case 'lxhz':
...
case 'shouquan':
	...
	break;
case 'author:铁柱':
	var ox = `春潮网资深作者，代表作：《界碑永存，英雄不朽》等。`;
	specialInfo('作者：铁 柱');
	break;
case 'author:上司几太':
	var ox = `春潮网作者。有作品《当我们告别行程卡时，我们在告别什么》。`;
	specialInfo('作者：上司几太');
	break;
case 'author:给你一拳':
	var ox = `春潮网资深作者。代表作品：《等待尘烟散去》等。`;
	specialInfo('作者：给你一拳');
	break;
case 'author:豆腐泡杀手':
	var ox = `春潮网资深作者。代表作品疫情系列文章。`;
	specialInfo('作者：豆腐泡杀手');
	break;
default:
	if(IS==='special') {
