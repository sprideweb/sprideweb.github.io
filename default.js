...
if(SYFL === '1') {
	...
	addAList('请使用现代浏览器访问本站页面','2021','10','16');
}
...
case '20241026':
	...
	break;
case '20211016':
	var op = `<zz>\u3000\u3000本站采用部分最新技术以提升网站可读性，因此请使用现代浏览器访问本站页面，否则可能发生错误。<br/><br/>\u3000\u3000建议您使用以下浏览器版本：IE浏览器9.0版本及以上； Google Chrome浏览器 63版本及以上； 360浏览器9.1版本及以上，且IE内核9.0及以上。<br/><br/>\u3000\u3000使用非现代浏览器可能导致网页显示异常，影响您的阅读体验。</zz>`;
