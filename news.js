...
if (fileName === 'news.html') {
    ...
    case '7':
        ...
        `;
        addNews('春潮SPRIDE公众号稿费给付标准（试行）','2020-12-25')
        break;
    case '29':
        var n=`
        ...
        `;
        addNews('2023年第二届“云端的单身情歌”东北师大附中毕业生线上合唱活动成功举办','2023-11-15');
        break;
    ...
    default:
        ...
        document.getElementById('wznr').innerHTML=`<empty><img src="https://1.s140i.faiscm.com/4/AIwBCAAQBBgAIIXChu0FKKi909UGMLAEOPwC.png"/><br/>找不到文章</empty>`;
        break;
    }
}
