...
document.getElementById("bottomjs").innerHTML = "<br/><div class=\"dbottom\"><br/><p>版权所有 Copyright (c) 2020- 2022 春潮信息化网 all right reserved.<br/> 【春潮信息化办公室主办】 地址：长春市清华路818号 <br/>网站备案号：内部(2020)07号 吉ICP备34712870号-6（正在申请中） <iframe src=\"https://spride.asia/e/v-iframe-sm.html?id=CC2007BS4&&fsz=14\" style=\"display:inline-block;border: none;width: auto;height: 13px;width: 280px!important;\"></iframe></p></div>";
...
document.getElementById("gonggao").innerHTML = "<a href=\"show.html?sid=103\">停机公告</a><a href=\"show.html?sid=102\">可信网站验证中心使用手册</a>";
...
if(aNum === "103") {
	    binfo("停机公告","2024/09/06","信息化办公室","<p>已删除</p>");
}
